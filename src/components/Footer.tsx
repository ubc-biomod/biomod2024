...
const Footer: React.FC = () => {
  ...
  useEffect(() => {
    ...
    import('react-fast-marquee').then((module) => setMarquee(() => module.default));
  }, []);

  return (
    <div className="flex flex-col bg-[#d9d9d9] items-center">
      <h1 className="text-2xl md:text-4xl font-bold mt-10">Meet the UBC BIOMOD Team</h1>
      <h4 className="text-md mt-4 mb-1">{activeText}</h4>
      ...
      <div className="flex flex-row items-center mt-10">
        <a href="https://instagram.com" target="_blank" rel="noopener noreferrer">
          <img src="instagram.png" alt="Instagram" className="w-8 h-8 cursor-pointer" />
        </a>
        <a href="https://youtube.com" target="_blank" rel="noopener noreferrer">
          <img src="youtube.png" alt="YouTube" className="w-8 h-8 cursor-pointer mx-12" />
        </a>
        <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer">
          <img src="linkedin.png" alt="LinkedIn" className="w-8 h-8 cursor-pointer" />
        </a>
      </div>

      <div className="flex flex-row items-center my-10 space-x-8">
        <a href="https://google.com" target="_blank" rel="noopener noreferrer" className="underline hover:font-bold">
          Email Us
        </a>
        <a href="https://google.com" target="_blank" rel="noopener noreferrer" className="underline hover:font-bold">
          Become a Sponsor
